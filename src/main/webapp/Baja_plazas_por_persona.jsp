<%@ include file="common/header-sesion.jsp" %>
	<%@ include file="common/nav.jsp" %>
		<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
					...
					<div class="autoComplete_wrapper">
						<div class="row">
							...
							<div class="col-4 separacion-pequeña">
								...
								<button type="button" class="btn btn-danger"  id="btnDardeBajaPorPlaza"
									style="margin-left: 20px;" disabled>Baja
					...
					<div class="autoComplete_wrapper1" style="display: none;">
						<div class="row">
							...
							<div class="col-4 separacion-pequeña">
								...
								<button type="button" class="btn btn-danger"  id="btnDardeBajaPorPersona"
									style="margin-left: 20px;" disabled>Baja
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
										<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293z"></path>
									</svg>
						...
						<div class="tab-pane fade show active" id="datosPlaza" role="tabpanel"
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="row">
										<div class="col-4 separacion-pequeña">
											<b>Motivos de Obligación de Declaración Patrimonial</b> <br> <br>
			...
			<script src="js/Baja_plazas_por_persona.js"></script> -->
