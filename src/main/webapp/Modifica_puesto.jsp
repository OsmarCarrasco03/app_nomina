...
<div
	...
	<div
		...
		<button style="margin-left: 10px;" type="button"
			class="btn btn-success" id="habilitarBusqueda"
		...
		<div class="modal-dialog modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="seleccionarBtn" onclick="crearArregloJSON()">Seleccionar 
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
							<path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
						</svg>
					</button>
	...
	<div class="text-center div-separacion-chica">
		<div class="row justify-content-md-center">
			...
			<div class="col-2" id="situacionDiv">
				...
				<label><b>Situación</b></label> <input type="text" disabled
		...
		<div class="row justify-content-md-center div-separacion-chica">
			...
			<div class="col">
				...
				<select id="Tipo" class="form-select"
					class="form-select is-invalid" aria-label="Default select example">					
				</select>
			</div>
			<div class="col">
...
<select id="Clasificacion_Interna" class="form-select"
					class="form-select is-invalid" aria-label="Default select example">					
				</select>
			</div>
			<div class="col">

				<label><b>Declaracion Patrimonial</b></label> 
<select id="Declaracion" class="form-select"
		...
		<div
			class="row justify-content-md-center div-separacion-mediana div-separacion-chica">
		</div>
	</div>
</div>
	...
	<div class="text-center div-separacion-chica ">
		<div class="row justify-content-md-center">
			...
			<div class="col-4" id="situacionDiv">
				...
				<label><b>Usuario que Capturó</b></label> <input type="text"
					class="form-control" id="UsuarioCapturo" disabled/>
			</div>
		</div>
		...
		<div class="row justify-content-md-center div-separacion-chica">
			...
			<div class="col-6">
				...
				<label><b>Usuario que realizó la última modificación</b></label> <input
					type="text" id="UsuarioUltMod" class="form-control" disabled />
			</div>
		</div>
...
<button type="button" class="btn btn-success" id="botonRegistar" disabled
					onclick="Registro()">Registrar
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
						<path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5"/>
						<path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708z"/>
					</svg>
...
<script src="js/Modifica_puesto.js"></script>
