        ...
        <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            ...
            <div class="container rounded div-padding input-color separacion-pequeña">
                ...
                <div class="text-center espacio-titulo">
                    <h3>CONSULTA CONCEPTOS VARIABLES</h3>
                </div>
                ...
                <thead class="text-center align-middle table-dark">
                    <tr>
                        ...
                        <th rowspan="2">Cpto_antec</th>
                        <th rowspan="2">Pagon_antec</th>
                        <th rowspan="2">Tipo_Factor</th>
                        <th rowspan="2">Factor</th>
                        <th rowspan="2">Importe</th>
                        <th rowspan="2">Nomina</th>
            ...
            <script src="js/consultaConceptosVariables.js"></script>
