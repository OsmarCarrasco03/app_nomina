...
<div
	...
	<div class="text-center espacio-titulo">
		...
		<div class="row justify-content-md-center div-separacion-debajo">
			...
			<div class="col-5">
				<p class="text-start espacio-inputs"><b>Empleado</b></p>
		...
		<div class="text-center">
			<form id="formulario">
				...
				<div class="row justify-content-md-center div-separacion-debajo">
					...
					<div class="col-3">
						<p class="text-start espacio-inputs"><b>Alias de Usuario</b></p>
						<input type="text" class="form-control" id="usu_alias" disabled/>
					</div>

					<div class="col-3">
						<p class="text-start espacio-inputs"><b>Nombre de Usuario</b></p>
						<input type="text" class="form-control" id="usu_usuario" disabled />
					</div>
					
					<div class="col-3">
						<p class="text-start espacio-inputs"><b>Rol de Usuario</b></p>
						<input type="text" class="form-control" id="usu_administrador" disabled />
					</div>
		...
		<div class="text-center justify-content-md-center div-separacion-md1">
			<button type="button" class="btn btn-danger" id="botonLimpiarCaptura"
				onclick="LimpiarCaptura()" disabled>Limpiar Consulta
			...
			<form id="datosDeControl">
				...
				<div class="row div-separacion-debajo">
					...
					<div class="col-4" id="divFechaTerminoVacia" hidden>
						<p class="text-start espacio-inputs"><b>Fecha de termino</b></p>
						<input class="form-control" type="text" id="fechaTerminoVacia" value="N/A" disabled>
					</div>
